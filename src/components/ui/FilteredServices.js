            ...
            <div className="grid lg:grid-cols-10 grid-cols-1 gap-4 lg:p-12 p-4 bg-blue-950">
                <div className="col-span-6">
                    <input
                        ...
                        className="px-4 py-4 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 w-full rounded"
                    />
                </div>
                ...
                <div className="flex lg:gap-4 gap-2 col-span-4">
                    <select
                        ...
                        className="px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded"
                    >
